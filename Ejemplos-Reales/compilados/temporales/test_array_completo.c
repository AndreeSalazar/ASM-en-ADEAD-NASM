...
int main(void) {
    int64_t _init_arr_0[] = { 3LL, 1LL, 4LL, 1LL, 5LL };
    Array arr = array_from_values(5, _init_arr_0);
    printf("%ld\n", array_len(&arr)); fflush(stdout);
    array_append(&arr, 9LL);
    printf("%ld\n", array_len(&arr)); fflush(stdout);
    int64_t last = array_pop(&arr);
    printf("%ld\n", last); fflush(stdout);
    printf("%ld\n", array_len(&arr)); fflush(stdout);
    array_insert(&arr, (size_t)(2LL), 7LL);
    printf("%ld\n", array_get(&arr, (size_t)(2LL))); fflush(stdout);
    printf("%ld\n", array_len(&arr)); fflush(stdout);
    array_remove(&arr, 1LL);
    printf("%ld\n", array_len(&arr)); fflush(stdout);
    int64_t idx = array_index(&arr, 4LL);
    printf("%ld\n", idx); fflush(stdout);
    int64_t cnt = array_count(&arr, 1LL);
    printf("%ld\n", cnt); fflush(stdout);
    array_sort(&arr);
